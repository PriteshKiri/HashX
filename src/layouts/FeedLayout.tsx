        ...
        >
          ...
          >
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: "12px",color:"white" }}>Personalized</p>
            </div>
            <div
              className={
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: "12px",color:"white" }}>Following</p>
            </div>
            <div
              className={
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: "12px",color:"white" }}>Featured</p>
            </div>
          </div>
